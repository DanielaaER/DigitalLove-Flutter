...
class CustomLabelHairAutocomplete extends StatefulWidget {
  final ValueChanged<String> onSelected;

  CustomLabelHairAutocomplete({
    required this.onSelected,
  });

  @override
  _CustomLabelHairAutocompleteState createState() =>
      _CustomLabelHairAutocompleteState();
}

class _CustomLabelHairAutocompleteState
    extends State<CustomLabelHairAutocomplete> {
  var suggestions = ['STRAIGHT_HAIR', 'WAVY_HAIR'];
  String selectedLabels = "STRAIGHT_HAIR";
