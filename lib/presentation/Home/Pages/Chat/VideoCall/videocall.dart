...
import 'package:digital_love/config/conf.dart';

class TypedVideoCallV2Example extends StatefulWidget {
  late String nameUserCall;
  late String nameUserToCall;

  TypedVideoCallV2Example({required this.nameUserCall, required this.nameUserToCall});
  @override
...
class _VideoCallV2ExampleState extends State<TypedVideoCallV2Example> {
  ...
  void initState() {
    ...
    super.initState();
    initJanusClient();
    nameUserCall = widget.nameUserCall;
    loadDevices();
