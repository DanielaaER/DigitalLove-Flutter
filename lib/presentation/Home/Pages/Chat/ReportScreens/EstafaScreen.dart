...
class EstafaScreen extends StatefulWidget {
  final int usuarioRecibe;

  const EstafaScreen({Key? key, required this.usuarioRecibe}) : super(key: key);

  @override
  _EstafaScreenState createState() => _EstafaScreenState();
}

class _EstafaScreenState extends State<EstafaScreen> {
