...
class OtroScreen extends StatefulWidget {
  final int usuarioRecibe;

  const OtroScreen({Key? key, required this.usuarioRecibe}) : super(key: key);

  @override
  _OtroScreenState createState() => _OtroScreenState();
}

class _OtroScreenState extends State<OtroScreen> {
