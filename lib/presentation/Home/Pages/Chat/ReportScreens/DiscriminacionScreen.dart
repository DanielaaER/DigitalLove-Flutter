...
class DiscriminacionScreen extends StatefulWidget {
  ...
  const DiscriminacionScreen({Key? key, required this.usuarioRecibe})
      : super(key: key);

  @override
  _DiscriminacionScreenState createState() => _DiscriminacionScreenState();
}
